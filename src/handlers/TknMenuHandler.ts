...
import { KnUtility, VerifyError, KnContextInfo, KnValidateInfo, KnDataSet, KnDataTable, KnDataMapRecordSetting } from '@willsofts/will-core';
import { TknOperateHandler } from "./TknOperateHandler";

export class TknMenuHandler extends TknOperateHandler {
    public progid = "menu";
    ...
    public createSideBarMenu(rs: KnResultSet) : SideBarMenuKnDataSet {
...
export interface SideBarMenuKnDataSet {
    sidemap: KnDataSet;
    sidelist: KnDataSet;
}
