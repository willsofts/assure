...
export class KnPageFacility extends KnPageUtility {
			...
			if(addedOn || DISPLAY_FONT_CONTROL || DISPLAY_VERSION_CONTROL) {
				...
				if(DISPLAY_FONT_CONTROL) {
					if(DISPLAY_VERSION_CONTROL) {
						buf += "						<li><a href=\"javascript:void(0)\" id=\"viewversionlinker\" class=\"viewversion-linker\" data-pid=\""+options.pid+"\"><i class=\"fa fa-info-circle fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"viewversion_label\">"+versionlabel+"</span></a></li>\n";
					}
					buf += "						<li><a href=\"javascript:void(0)\" id=\"increasefontlinker\" class=\"increase-linker\"><i class=\"fa fa-plus-square fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"fsincreasefont_label\">"+inclabel+"</span></a></li>\n";
					buf += "						<li><a href=\"javascript:void(0)\" id=\"decreasefontlinker\" class=\"decrease-linker\"><i class=\"fa fa-minus-square fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"fsdecreasefont_label\">"+declabel+"</span></a></li>\n";
				} else {
					if(DISPLAY_VERSION_CONTROL) {
						buf += "						<li><a href=\"javascript:void(0)\" id=\"viewversionlinker\" class=\"viewversion-linker\" data-pid=\""+options.pid+"\"><i class=\"fa fa-info-circle fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"fsviewversion_label\">"+versionlabel+"</span></a></li>\n";
					}
				}
				if(addedOn) {
					buf += "						"+options.addon;
    ...
    protected createInLineHeader(options: KnHeaderInfo) : string {
		...
		if(DISPLAY_PROGRAM_CONTROL) {
			...
			if(addedOn || DISPLAY_FONT_CONTROL || DISPLAY_VERSION_CONTROL) {
				...
				if(DISPLAY_FONT_CONTROL) {
					if(DISPLAY_VERSION_CONTROL) {
						buf += "						<li><a href=\"javascript:void(0)\" id=\"viewversionlinker\" class=\"viewversion-linker\" data-pid=\""+options.pid+"\" onclick=\"viewVersion('"+options.pid+"')\"><i class=\"fa fa-info-circle fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"viewversion_label\">"+versionlabel+"</span></a></li>\n";
					}
					buf += "						<li><a href=\"javascript:void(0)\" id=\"increasefontlinker\" class=\"increase-linker\" onclick=\"increaseFontSize()\"><i class=\"fa fa-plus-square fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"fsincreasefont_label\">"+inclabel+"</span></a></li>\n";
					buf += "						<li><a href=\"javascript:void(0)\" id=\"decreasefontlinker\" class=\"decrease-linker\" onclick=\"decreaseFontSize()\"><i class=\"fa fa-minus-square fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"fsdecreasefont_label\">"+declabel+"</span></a></li>\n";
				} else {
					if(DISPLAY_VERSION_CONTROL) {
						buf += "						<li><a href=\"javascript:void(0)\" id=\"viewversionlinker\" class=\"viewversion-linker\" data-pid=\""+options.pid+"\" onclick=\"viewVersion('"+options.pid+"')\"><i class=\"fa fa-info-circle fa-class\" aria-hidden=\"true\"></i>&nbsp;<span id=\"fsviewversion_label\">"+versionlabel+"</span></a></li>\n";
					}
				}
				if(addedOn) {
					buf += "						"+options.addon;
    ...
    protected buildBindingPaging(options: KnPagingInfo = {jsFunction: "submitChapter",jsForm: "fschapterform", searchForm: "fssearchform"}) : string {
		...
		if(fsLimit>0 && (fsPages>fsLimit)) {
			...
			buf += "<A HREF=\"javascript:void(0)\" class=\"page-link pagenoclass fa-data-page\" data-paging=\"1\">";
			buf += "|&lt;</A>";
			buf += "</li>\n";
			buf += "<li class=\"page-item page-column-class\">";
			buf += "<A HREF=\"javascript:void(0)\" class=\"page-link pagenoclass fa-data-page\" data-paging=\""+fsPreviousPage+"\">";
			buf += "&lt;&lt;</A>";
			buf += "</li>\n";
			table = "";			
		}
		for(let i=0;i<fsRows;i+=fsChapters) {
			...
			if(fsLimit>0) {
				...
				if(fsLimit<fsPageNo) {
					...
					buf += table;
					buf += "<li class=\"page-item page-column-class\">";
					buf += "<A HREF=\"javascript:void(0)\" class=\"page-link pagenoclass fa-data-page\" data-paging=\""+fsPageNumber+"\">";
					buf += "&gt;&gt;</A>";
					buf += "</li>\n";
					table = "";
					break;
