...
import { META_INFO, RELEASE_VERSION, CDN_URL, BASE_URL, API_URL, REDIRECT_URL, MESSAGE_URL, EXCEPT_LAUNCH_PATH, BASE_STORAGE, ALLOW_RAW_PARAMETERS } from "../utils/EnvironmentVariable";
